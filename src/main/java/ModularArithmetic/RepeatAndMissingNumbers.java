...
//        int A[] = {1,3,2,4,4};
        int M = A.length-1; int A1=0; int B=0; int count1 = 0; int countMGreater = 0;
...
//        System.out.println(factors);
        ...
        if(count1 > 1) A1 = 1;
        else if(countMGreater > 1) A1 = M+1;
            for(int j :factors){
               if(j != 1) B=j;
            }
            if(count1==0) B=1;
            else if(countMGreater==0) B = M+1;
...
//                if (factors.get(i - 2) == 1) {
//                    if (count1 > 1) A1 = 1;
//                    else A1 = M;
//                    B = M + 1;
//                } else if (factors.get(i - 2) == M) {
//                    if (A1 == 0)
//                        A1 = M + 1;
////                    if (A[i] > factors.get(i - 2))
////                        A1 = 1;
//                    B = M;
//                } else {
